...
import { PrivateKey, SKCipher,
         SKCiphererFactory } from '@bellerophon-mobile/hippo'
import { AES_256_CBC, AES_256_GCM,
         AESSKCipherer } from '@bellerophon-mobile/hippo/webcrypto'
